...
useHead({
  ...
  meta: [
    ...
    { name: "title", content: "LVenture Group" },
    { name: "description", content: "Investing in Change" },
    { name: "keywords", content: "VC, Investing, in, Change" },
...
<template>
  ...
  <div
    id="maincontent"
    class="flex flex-col gap-16 mx-auto px-2 md:px-20 mb-32 max-w-[100rem] pt-[86px]"
  >
    <slot />
  </div>
  <Footer />
